...
*Version 1.0.0 built with the Cruip CSS is available [here](https://github.com/someRandomNetizen/FE-Web-2-/releases/tag/1.0.0).*
*Version 2.0.3 built with Tailwind CSS and React + Vite is available [here](https://github.com/someRandomNetizen/FE-Web-2-/releases/tag/2.0.3).*
