      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Thợ Giỏi Tâm Huyết</h2>
            <p className="text-xl text-gray-400">
              Đội ngũ thợ có bằng cắp, đã qua đào tạo chuyên môn về các ngành
              nghề. Có kinh nghiệm lâu năm, luôn làm việc với tinh thần cao
              nhất. Tuân thủ quy trình kỹ thuật và đảm bảo an toàn
            </p>
          </div>
